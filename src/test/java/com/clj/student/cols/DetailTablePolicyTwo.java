...
// import com.cloud.module.management.vo.*;
...
public class DetailTablePolicyTwo extends DynamicTableRenderPolicy {
...
//        }
//
//        DocumentDatas documentData = (DocumentDatas)model;
//        List<Instances> instances = documentData.getDetailTable().getDataBaseList();
//        Map<String, List<DataBases>> rowInstanceData = documentData.getDetailTable().getRowInstanceData();
//
...
//        titleRun.setFontFamily("创艺简标宋 20号");
...
//            rowIndex++;
//            List<DataBases> dataBases = rowInstanceData.get(key);
...
//                    String rank = "";
//
//                    if (!StringUtils.isEmpty(dataBase.getBelongCompany())){
//                        if (!dataBase.getBelongCompany().contains("翔安城建") ){
//                            if (!StringUtils.isEmpty(dataBase.getParallelOptions())){
//                                if (dataBase.getParallelOptions().equals("-")){
//                                    row.getCell(2 + i * 2 + 1).setText("成绩未公布");
//                                } else if (dataBase.getParallelOptions().equals("/")){
//                                    row.getCell(2 + i * 2 + 1).setText("成绩不考核");
//                                } else if (!StringUtils.isEmpty(dataBase.getRank())){
//                                    if (!StringUtils.isEmpty(dataBase.getAssessmentsNum())){
//                                        if (dataBase.getJuxtaposed().equals("1")){
//                                            rank = dataBase.getParallelOptions()+dataBase.getRank()+ "/" +dataBase.getAssessmentsNum()+"(并列)";
//                                            row.getCell(2 + i * 2 + 1).setText(rank);
//                                        }else {
//                                            rank = dataBase.getParallelOptions()+dataBase.getRank()+ "/" +dataBase.getAssessmentsNum();
//                                            row.getCell(2 + i * 2 + 1).setText(rank);
//                                        }
//                                    }else {
//                                        if (dataBase.getJuxtaposed().equals("1")){
//                                            rank = dataBase.getParallelOptions()+dataBase.getRank()+("并列");
//                                            row.getCell(2 + i * 2 + 1).setText(rank);
//                                        }else {
//                                            rank = dataBase.getRank();
//                                            row.getCell(2 + i * 2 + 1).setText(rank);
//                                        }
//                                    }
//                                } else {
...
//                            }
//                        }else {
//                            row.getCell(2 + i * 2 + 1).setText(dataBase.getRemak());
//                        }
//                    }else {
//                        row.getCell(2 + i * 2 + 1).setText("");
//                    }
